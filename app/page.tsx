      ...
      <section className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        <div className="space-y-6 max-w-md">
          ...
          <div className="grid grid-cols-3 gap-3">
            <Button 
              variant="ghost" 
              className="flex flex-col items-center gap-2 p-3 rounded-xl bg-card/50 border border-border/50 h-auto p-3 hover:bg-card hover:border-primary data-[state=open]:bg-transparent"
                ...
                <CardContent className="flex flex-col items-center gap-4 p-6">
                  <div className="bg-white p-6 rounded-xl shadow-2xl">
                    <QRCodeCanvas
                      ...
                      }/join?code=${liveEvent.event_code}`}
                      size={220}
                      level="H"
                      includeMargin={false}
                    />
